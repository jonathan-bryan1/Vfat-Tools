$(function() {
  ...
  async function main() {
    ...
    _print(`Total staked: ${totalStakedSPGLETH / 1e18}`)
    ...
    _print(`Total staked: ${totalStakedSPGLPNG / 1e18}`)
    ...
    _print(`Total staked: ${totalStakedSNOBAVAX / 1e18}`)
    ...
    _print(`Total staked: ${totalStakedSPGLSUSHI / 1e18}`)
